...
class solObs(FPDF):
    ...
    def solicitudesObs(request, id ):
        ...
        pdf.output('solicitudesObservadas.pdf', 'F')
        return FileResponse(open('solicitudesObservadas.pdf', 'rb'), as_attachment=True, content_type='application/pdf')
