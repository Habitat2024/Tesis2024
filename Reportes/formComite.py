...
class formularioC(FPDF):
    
    def formComite(request, id ):
        ...
        pdf.cell(w=7,h=3,txt='X' if hasattr(do.IdAlternativa, 'IdAlternativa') and do.IdAlternativa.Alternativa == 'CONSTRUCCION VIVIENDA IN SITU' else '', border=1, align='C', fill=False)
        pdf.cell(w=30,h=5,txt='Const. Vivienda', border='', align='C', fill=False)
        pdf.cell(w=7,h=3,txt='X' if hasattr(do.IdAlternativa, 'IdAlternativa') and do.IdAlternativa.Alternativa == 'MEJORAMIENTO' else '', border=1, align='C', fill=False)
        pdf.cell(w=30,h=5,txt='Mejoramiento', border='', align='C', fill=False)
        pdf.cell(w=7,h=3,txt='X' if hasattr(do.IdAlternativa, 'IdAlternativa') and do.IdAlternativa.Alternativa == 'VIVIENDA USADA' else '', border=1, align='C', fill=False)
        pdf.cell(w=20,h=5,txt='V. Usada', border='', align='C', fill=False)
        pdf.cell(w=7,h=3,txt='X' if hasattr(do.IdAlternativa, 'IdAlternativa') and do.IdAlternativa.Alternativa == 'VIVIENDA NUEVA' else '', border=1, align='C', fill=False)
        pdf.cell(w=20,h=5,txt='V. Nueva', border='', align='C', fill=False, ln=1)
        pdf.cell(w=0,h=3,txt='', border=0, align='C', fill=False, ln=1)
        pdf.cell(w=45,h=5,txt='', border=0, align='L', fill=False)
        pdf.cell(w=5,h=5,txt='', border=0, align='C', fill=False) 
        pdf.cell(w=7,h=3,txt='X' if hasattr(do.IdAlternativa, 'IdAlternativa') and do.IdAlternativa.Alternativa == 'LOTE MAS VIVIENDA' else '', border=1, align='C', fill=False)
        pdf.cell(w=30,h=5,txt='Lote + Vivienda', border='', align='C', fill=False)
        pdf.cell(w=7,h=3,txt='X' if hasattr(do.IdAlternativa, 'IdAlternativa') and do.IdAlternativa.Alternativa == 'CORPORATIVO' else '', border=1, align='C', fill=False)
        pdf.cell(w=30,h=5,txt='Coorporativo', border='', align='C', fill=False)
        pdf.cell(w=7,h=3,txt='X' if hasattr(do.IdAlternativa, 'IdAlternativa') and do.IdAlternativa.Alternativa == 'PROYECTO ESPECIAL' else '', border=1, align='C', fill=False)
        ...
        pdf.output('formularioComite.pdf', 'F')
        return FileResponse(open('formularioComite.pdf', 'rb'), as_attachment=True, content_type='application/pdf')
