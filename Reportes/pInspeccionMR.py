...
class pinspmr(FPDF):
    ...
    def pInspeccionMR(request, id ):
        ...
        try:
            imgpim= ImagenPrimInsMej.objects.get(IdPrimeraInspMej=pim.Id)
        ...
        try:  
            ...
            img_path = imgpim.Imagen.path  # Asumiendo que es un campo FileField o ImageField
        ...
        pdf.cell(w=0,h=6,txt= DMipm.DiasEsti if hasattr(DMipm, 'DiasEsti') else '', border=1, align='C', fill=False, ln=1)
