...
class ConozcaC(FPDF):
    ...
    ##########################################
        ...
        pdf.cell(w=0,h=10,txt='ASOCIACIÓN HPH EL SALVADOR', border='TRL',  align='C', fill=True, ln=1)
        pdf.cell(w=0,h=10,txt='CONOZCA A SU CLIENTE', border='BLR',  align='C', fill=True, ln=1)
        ...
        pdf.cell(w=50,h=5,txt='Nombre completo del beneficiario:' , border='LTB', align='L', fill=False)
        pdf.set_text_color(0,0,0)
        pdf.multi_cell(w=146,h=5,txt= str(cdpbo.NombreComp if hasattr(cdpbo,'NombreComp') else' --------------------------------------------------') or '--------------------------------------------------', border='TBR', align='L', fill=False)
        pdf.set_text_color(r,g,b)
        pdf.cell(w=196,h=5,txt='Dirección permanente del beneficiario:'+ (str(cdpbo.DireccionPerm if hasattr(cdpbo, 'DireccionPerm') else'     ---------------------------------------------') or '      ---------------------------------------------'), border=1, align='L', fill=False, ln=1)
        pdf.cell(w=196,h=5,txt='Tipo y número de documento de indentificación:'+ (str(cdpbo.TipoDocuPers if hasattr(cdpbo, 'TipoDocuPers') else'    -------------------------------------') or '      -------------------------------------'), border=1, align='L', fill=False, ln=1)
        ...
        if cpeps!="" and str(cpeps.Grado) =='Segundo':
            if cpeps!="" and str(cpeps.Parentesco) =='Abuelo': 
                pdf.cell(w=11,h=4,txt='Abuelo-', border='LBT', align='L', fill=False )
                pdf.cell(w=11,h=4,txt='Abuela-', border='T', align='L', fill=False )
                pdf.multi_cell(w=0,h=4,txt='Hermano-', border='RT', align='L', fill=False )
                pdf.set_xy(172,97)
                pdf.cell(w=11,h=4,txt='Hermana-', border='L', align='L', fill=False )
                pdf.cell(w=11,h=4,txt='Cuñado-', border='', align='L', fill=False )
                pdf.multi_cell(w=0,h=4,txt='Cuñada-', border='R', align='L', fill=False )
                pdf.set_xy(172,100)
                pdf.cell(w=11,h=4,txt='Nieto-', border='', align='L', fill=False )
                pdf.cell(w=11,h=4,txt='Nieta-', border='', align='L', fill=False )
                ...
                pdf.cell(w=11,h=4,txt='Abuelo-', border='LT', align='L', fill=False )
                pdf.cell(w=11,h=4,txt='Abuela-', border='T', align='L', fill=False )
                pdf.multi_cell(w=0,h=4,txt='Hermano-', border='RT', align='L', fill=False )
                pdf.set_xy(172,97)
                pdf.cell(w=11,h=4,txt='Hermana-', border='L', align='L', fill=False )
                ...
                pdf.multi_cell(w=0,h=4,txt='Cuñada-', border='R', align='L', fill=False )
                pdf.set_xy(172,100)
                pdf.cell(w=10,h=4,txt='Nieto-', border='', align='L', fill=False )
                pdf.cell(w=10,h=4,txt='Nieta-', border='', align='L', fill=False )
                pdf.multi_cell(w=0,h=4,txt='Concuñado-', border='R', align='L', fill=False )
                pdf.set_xy(172,104)
                pdf.multi_cell(w=0,h=4,txt='Abuelos del conyuge', border='R', align='L', fill=False )
        else:
